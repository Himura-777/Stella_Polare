  ...
  >
    ...
    <main class="pt-12 pb-20">
      ...
      >
        ...
        <p
          class="relative z-20 mx-auto w-[35.4%] text-2xl text-white/80 font-normal text-center mt-10 mb-[3.75rem]"
        >
      ...
      <section class="my-[8.75rem] mx-[3.907%]">
        ...
        <p class="mx-auto w-[30.5%] text-2xl text-white/70 text-center font-medium">
      ...
      >
        <div class="w-[29.04%] z-20 mx-[3.907%]">
          <h2
        ...
        <ul class="w-[52.12%] flex flex-col gap-y-4 z-10 mx-[3.907%]">
